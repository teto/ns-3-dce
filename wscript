...
def configure(conf):
    ...
    ns3waf.check_modules(conf, ['fd-net-device'], mandatory = True)
    ns3waf.check_modules(conf, ['tap-bridge'], mandatory = True)
    ns3waf.check_modules(conf, ['netanim'], mandatory = True)
